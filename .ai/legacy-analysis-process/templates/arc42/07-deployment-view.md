# 7. Infrastructure, Hosting Environment, and Deployment Topology

<!--
Arc42 Section 7: Deployment View (Renamed)
Original: "Deployment View"
New: "Infrastructure, Hosting Environment, and Deployment Topology"
...
Key content: Servers, cloud resources, network topology, environments
-->
...
- [Domain Rules](08-domain-rules-and-guidelines.md) - Logging, monitoring details
