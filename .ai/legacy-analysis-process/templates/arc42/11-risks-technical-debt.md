# 11. Known Technical Risks, Limitations, and Current Debt

<!--
Arc42 Section 11: Risks and Technical Debt (Renamed)
Original: "Risks and Technical Debt"
New: "Known Technical Risks, Limitations, and Current Debt"

Documents known technical risks and accumulated technical debt.
Key content: What is broken, risky, or needs refactoring
-->
...
## 11.9 Technical Debt Summary (from Artifacts)

> **Documentation Strategy**: Arc42 provides debt summaries with links to detailed analysis artifacts.
> Full analysis lives in `artifacts/05-analysis/`.

### Debt Overview from Analysis
...
**Top 5 Debt Items (from Component Analysis)**:

| ID | Issue | Source Artifact | Impact | Effort |
|----|-------|-----------------|--------|--------|
| {TD-001} | {Issue description} | SA-XX-{component}.md | High | {n} days |
| {TD-002} | {Issue description} | SA-XX-{component}.md | High | {n} days |
| {TD-003} | {Issue description} | SA-XX-{component}.md | Medium | {n} days |
| {TD-004} | {Issue description} | SA-XX-{component}.md | Medium | {n} days |
| {TD-005} | {Issue description} | SA-XX-{component}.md | Medium | {n} days |

> **Full Inventory**: See [TECHNICAL-DEBT-INVENTORY.md](../artifacts/05-analysis/TECHNICAL-DEBT-INVENTORY.md) for all {n} debt items.

### Debt by Component

| Component | Debt Items | Critical | Source Artifact |
|-----------|------------|----------|-----------------|
| Common Libraries | {n} | {n} | `SA-01-common-libraries.md` |
| Search Services | {n} | {n} | `SA-02-search-services.md` |
| Sync Components | {n} | {n} | `SA-04-sync-components.md` |
| Database Layer | {n} | {n} | `SA-12-prod-packages.md` |

> **Component Analysis**: See `artifacts/05-analysis/csharp/` and `artifacts/05-analysis/database/` for detailed component analysis.

---

## 11.10 Tribal Knowledge Summary

> **Documentation Strategy**: Tribal knowledge captured from stakeholder interviews is summarized here.
> Full catalog lives in `artifacts/07-synthesis/requirements/SA-TRIBAL-KNOWLEDGE.md`.

### Tribal Knowledge Highlights

| Category | Items | Source |
|----------|-------|--------|
| **Business Rules (Implicit)** | {n} | Stakeholder interviews |
| **Historical Context** | {n} | Principal Engineer |
| **Operational Knowledge** | {n} | Operations team |
| **"Why It's Built That Way"** | {n} | DBA, Architects |

> **Full Catalog**: See [TRIBAL-KNOWLEDGE.md](../artifacts/07-synthesis/requirements/TRIBAL-KNOWLEDGE.md) for all tribal knowledge.
...
|----------|-------------|----------|
| Technical Debt Inventory | All {n} debt items with remediation plans | `artifacts/05-analysis/TECHNICAL-DEBT-INVENTORY.md` |
| Component Analysis (C#) | Detailed C# component analysis | `artifacts/05-analysis/csharp/SA-*.md` |
| Component Analysis (DB) | Database analysis | `artifacts/05-analysis/database/SA-*.md` |
| Tribal Knowledge | Implicit rules and historical context | `artifacts/07-synthesis/requirements/TRIBAL-KNOWLEDGE.md` |
