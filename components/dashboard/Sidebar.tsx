    ...
    <>
      ...
      <div className="p-3 border-t border-sidebar-border space-y-1">
        <Link
          href="/cuenta"
          onClick={onNavigate}
          className="flex items-center gap-2 w-full px-3 py-2.5 rounded-md text-sm text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors"
        >
